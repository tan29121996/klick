...
function MovieThumbnailLeft({ movie, openModal, setMovieData }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 24, marginRight: -100 }}>
      ...
      <div id='click' style={{ position: 'relative', left: 20, width: 303, height: 170, borderRadius: 10,
...
export default MovieThumbnailLeft;
